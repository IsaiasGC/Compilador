...
public class Entrada extends javax.swing.JFrame {
    ...
    String[][] palabras = { { "funtion", "2" }, { "int", "2" }, { "float", "2" }, { "string", "2" }, { "boolean", "2" },
            { "AND", "4" }, { "OR", "4" }, { "if", "3" }, { "else", "3" }, { "while", "3" }, { "out", "1" },
            { "in", "1" }, { "main", "1" }, { "true", "4" }, { "false", "4" } };
    ...
    public void pintarAmarillo(int inicio, int fin) {
        ...
        StyleConstants.setForeground(amarillo, Color.ORANGE);
    ...
    public void inicializar() {
        ...
        texto.addKeyListener(new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                /*
                 * sketch=sketch.substring(0, p)+e.getKeyChar()+sketch.substring(p+1,
                 * sketch.length()-1); System.out.println(sketch); texto.getDocument().remove(0,
                 * texto.getText().length()); Thread.sleep(3000); texto.setText(sketch);
                 */
                buscar();
                revisar();
            }
    ...
    private void initComponents() {
        ...
        texto.setFont(new java.awt.Font("mononoki NF", 0, 14)); // NOI18N
        ...
        panelLayout.setHorizontalGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(panelLayout.createSequentialGroup().addContainerGap()
                        .addGroup(panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jScrollPane2).addGroup(panelLayout.createSequentialGroup()
        ...
        jMenuBar1.setBackground(new java.awt.Color(101, 101, 101));
